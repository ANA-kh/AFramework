...
namespace AFramework.ResModule.Editor
{
    public class BundleBuilder
    {
        ...
        public void Build(string outputPath, BuildTarget buildTarget, BuildAssetBundleOptions options, string version, List<IBundleModifier> bundleModifierChain = null)
        {
        ...
        public virtual BundleManifest CreateBundleManifest(string rootFolder, AssetBundleManifest manifest, string version, string defaultVariant = null)
        {
            ...
            BundleManifest bundleManifest = new BundleManifest(bundles, version);
